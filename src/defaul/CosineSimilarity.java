...
public class CosineSimilarity {
  private double cosine_similarity = 0.0;
   ...
   */
  public double computeCosineSimilarity(Map<String, Integer> TAqueryVector,
    ...
    this.cosine_similarity = tempVar / (Math.sqrt(qSquareSum) * Math.sqrt(dSquareSum));
